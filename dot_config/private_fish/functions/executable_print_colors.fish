...
#
# Description:
#   Displays a formatted table of ANSI color codes in the terminal.
#   Each row shows:
#     - Standard foreground color (e.g., \033[31m for red)
#     - Standard background color (e.g., \033[41m for red background)
#     - Bright (light) foreground color (e.g., \033[91m for light red)
#     - Bright (light) background color (e.g., \033[101m for light red background)
#
#   This function is useful for previewing how ANSI color codes render in your terminal.
#   It helps with customizing prompts, themes, or scripts that use color output.
#
# Usage:
#   Run `print_colors` in a Fish shell to see the color table.

function print_colors --description 'Display a table of ANSI foreground and background color codes'
